  ...
  return (
    <div className={`modal ${modal && modal.about}`}>
      <div className="modal-box relative">
        ...
        <div>
          <p className="pb-4">
            Hello There! And thanks for stopping by and checking out my Disney AI Trivia Bot, built on the <a className="link text-sky-500" target="_blank" rel="noopener noreferrer" href="https://beta.openai.com/docs/introduction/overview">OpenAI GPT3 API</a>. 
          </p>
          <p className="pb-4">
